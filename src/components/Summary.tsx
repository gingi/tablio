          ...
          <Card className="p-3">
            ...
            <div className="space-y-1">
              {tables.map(table => {
                ...
                return (
                  <div key={table.id} className="flex items-center justify-between text-xs">
            ...
            <div className="space-y-1 text-xs">
              <div className="flex justify-between">
                ...
                <span className="text-green-600">
                  {tables.filter(t => t.guests.length >= 8 && t.guests.length <= 12).length}
                </span>
              </div>
              <div className="flex justify-between">
                <span>Under capacity (&lt;8):</span>
                <span className="text-yellow-600">
                  {tables.filter(t => t.guests.length > 0 && t.guests.length < 8).length}
                </span>
              </div>
              <div className="flex justify-between">
