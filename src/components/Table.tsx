    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
          ...
          {/* Status badge */}
          <Badge 
            className={`text-xs border ${tableStatus.badgeClass || 
              (tableStatus.badge === 'secondary' ? 'bg-gray-100 text-gray-600 border-gray-300' :
               tableStatus.badge === 'destructive' ? 'bg-red-100 text-red-800 border-red-300' : '')}`}
          >
            {tableStatus.text}
          </Badge>
